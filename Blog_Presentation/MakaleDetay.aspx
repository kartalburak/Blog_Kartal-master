        ...
        <div class="row">
            ...
            <div class="col-md-9" id="blog-post">
                ...
                <div id="comments">
                    ...
                    <h4 class="text-uppercase"><%# GetYorumSayisiByMakaleID(2)%></h4>
                        ...
                        <ItemTemplate>
                            ...
                            <div class="row comment">
                                ...
                                <div class="col-sm-9 col-md-10">
                                    <h5 class="text-uppercase"><%# Eval("Eposta") %></h5>
                                    <p class="posted"><i class="fa fa-clock-o"></i><%# Eval("YorumTarihi") %></p>
                                    <p><%# Eval("YorumIcerik") %></p>

                                    <p class="reply">
                                        <asp:LinkButton ID="lbcevapla" CommandName="Delete" CommandArgument='<%# Eval("YorumID") %>' CssClass="fa fa-reply" runat="server">Cevapla</asp:LinkButton>
                                    </p>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <li class="comment-box">
                                                ...
                                                <div class="comment">
                                                    ...
                                                    <div class="date-replay"><a href="#"><%# Eval("YorumTarihi") %></a> </div>
                                                    <p>
                                                        <%# Eval("YorumIcerik") %>
                                                    </p>
                                                </div>
